<%@ Page Title="" Language="C#" MasterPageFile="~/yonetim/yonetim.master" AutoEventWireup="true" CodeFile="Menuİslemleri.aspx.cs" Inherits="yonetim_Menuİslemleri" %>
        ...
        <div class="panel">
            ...
            <asp:Panel ID="PanelDuzenle" runat="server" Visible="false">
                <table class="table table-striped">
                    <tr>
                        <td>
                            <asp:Label ID="Label2" runat="server" Style="margin-left: 90px" Text="Menü Adı" Font-Bold="True"></asp:Label></td>
                        <td>
            ...
            <asp:Panel ID="PanelEkle" runat="server">
                <table class="table table-striped">
                    <tr>
                        <td>
                            <asp:Label ID="Label3" Style="margin-left: 90px" runat="server" Text="Menü Adı" Font-Bold="True"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtKategoriAdi" Style="margin-right: 90px; margin-left: 90px" runat="server"></asp:TextBox></td>
                        <td>
                            <asp:Button ID="Button1" runat="server" CssClass="btn btn-success container-fluid " OnClick="btnHaberEkle_Click" Style="margin-right: 190px" Text=" Kategori Ekle"  />
                        </td>
                    </tr>
                </table>
            </asp:Panel>
                        ...
                        <asp:Repeater ID="RepeaterKategorilerListele" runat="server">
                            <ItemTemplate>
                                <tr>
                                    ...
                                    <td class="text-center"><a class='btn btn-info btn-xs' href="Menuİslemleri.aspx?id=<%#Eval("menuİd")%>&islem=duzenle"><span class="glyphicon glyphicon-edit"></span>Düzenle</a></td>
                                    <td><a href="Menuİslemleri.aspx?id=<%#Eval("menuİd")%>&islem=sil" onclick="return confirm('Kayıt Silmek İstediğinizden Emin Misiniz ? ' )" class="btn btn-danger btn-xs"><span class="glyphicon glyphicon-remove"></span>Sil</a></td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>

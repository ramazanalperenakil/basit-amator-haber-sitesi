...
public partial class yonetim_KategoriEkle : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!Page.IsPostBack)
        {
            ...
            RepeaterKategorilerListele.DataSource = kod.GetDataTable("SELECT   *  FROM [Menu]  WHERE kosul = 1  ");
    ...
    protected void btnHaberEkle_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            kod.komut("Insert Into Menu  (MenuAdi, MenuUrl, kosul) VALUES ('" + txtKategoriAdi.Text + "', '" + url + "' , 1) ");

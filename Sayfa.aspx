<%@ Page Title="" Language="C#" MasterPageFile="~/ana.master" AutoEventWireup="true" CodeFile="Sayfa.aspx.cs" Inherits="Sayfa" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section class="container">
        ...
        <div class="row">
            <div class="col-8 ">
                <asp:Repeater ID="RepeaterSayfa" runat="server">
                    <ItemTemplate>
                        <h5 class="text-center"><%#Eval("SayfaAdi")%></h5>
                <img src="<%#Eval("SayfaResim")%>" class="img-fluid container-fluid" />
                <p>
                    <%#Eval("SayfaMetin")%>
                </p>
                    </ItemTemplate>
